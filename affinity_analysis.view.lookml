- view: order_product
  derived_table:
    ...
    sql: |
      SELECT o.id as order_id              -- this column indicates the type of transaction, in this case an Order
...
# Affinity Metrics
  ...
  - dimension: jaccard_similarity     ## Do not display unless users have a solid understanding of  statistics and probability models
